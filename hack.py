...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              HALO BROTHER")
    runntxt(WW+"   ..................  ANDA MENCOBA MENGHUBUNGI")
    runntxt(WW+"     ....       ALTOMEDIA")
    runntxt(GL+"                   BODO AMAT CUK")
    runntxt(GG+"     ..........     MANDI DULU SANA")
    runntxt(Y+"    ............       DILARANG GOBLLOK")
    runntxt(GG+"           INGAT GOBLOK ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••      NEW TOOLS HACK FACEBOOK    ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |                 BY: ALTOMEDIA               |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |                 [YOUTUBE](https://t.me/altomediacloudbot)         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         gunakan dengan bijak goblok "
...
def pil():
                ...
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Pilih yang bener goblok..."
                    pil()
...
def edit_wordlist():
        ...
        if ed == 'y' or ed == 'Y':
                ...
                print RR+"Pilih yg bener goblok..."
                edit_wordlist()
...
def main():
        ...
        life()
        print " "
        print RR+" wordlist tidak ada yg cocok goblok..."
        print " "
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;KDSMEDIA PROGRAMER\033[91;1m
             Powered by:\033[97m ALTOMEDIA
      """
